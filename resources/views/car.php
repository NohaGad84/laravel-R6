          ...
          <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-md-6 col-12 card-body">
              <div class="mb-4 text-center py-2">
                <h2 class="fw-bold bg-light card-header">Car Title</h2>
              </div>
              <div class="mb-4">
                <p class="card-text">
              ...
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Description:</span><br>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Deleniti, odio. Officia quos, optio molestias magnam pariatur iste, alias veniam placeat eum mollitia
                  esse atque voluptatem, maiores eos excepturi reprehenderit sint?
                </p>
              </div>
