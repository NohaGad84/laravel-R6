          ...
          <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-md-6 col-12 card-body">
              <div class="mb-4 text-center py-2">
                <h2 class="fw-bold bg-light card-header">{{$classe->classname}}</h2>
              </div>
              <div class="mb-4">
                <p class="card-text">
              ...
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Price:</span> {{$classe->price}}$
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Is Fulled:</span> {{$classe->is_fulled? 'Yes' :'No'}}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Time From:</span> {{$classe->time_from}}AM
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Time To:</span> {{$classe->time_to}}PM
                </p>
              </div>
